...
?> 
	...
	<div class="d-flex justify-content-center">
		<div class="row col-xs-12 col-lg-9"> 
			...
			<div class="col-xs-12 col-md-6 mb-2 pe-lg-0 pb-2">
				<section class="page-content mb-2" style="height:100%;">
					<h2 class="pt-2 ps-4">Services</h2>
					<hr/>

					<ul class="ps-2 pb-1">
						<li class="mb-3" style="line-height:1.3;">Virtual consultations and presentations</li>
						<li class="mb-3" style="line-height:1.3;">One-on-one consultations concerning individual pets</li>
						<li class="mb-3" style="line-height:1.3;">Group presentations regarding general pet care (can be tailored to the needs of the group)</li>
					</ul>
